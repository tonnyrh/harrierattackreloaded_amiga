...
Source of truth: amiga/assets/generated/cpc/cpc_plus_sprites.json (the same
audited source tools/promote_cpc_assets.py reads for the raw per-pixel pen
arrays already embedded in amiga/assets/cpc_promoted_assets.h).
"""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("amiga/assets/cpc_promoted_sprite_tiles.h"))
